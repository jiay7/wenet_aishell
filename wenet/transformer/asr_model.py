...
class ASRModel(torch.nn.Module):
    ...
    def _forward_encoder(
        ...
        # 1. Encoder
        #print("_forward_encoder: decoding_chunk_size:",decoding_chunk_size,"simulate_streaming:",simulate_streaming)
        if simulate_streaming and decoding_chunk_size > 0:
            #print("simulate_streaming:",simulate_streaming,"decoding_chunk_size:",decoding_chunk_size)
        ...
        #print("_forward_encoder: encoder_out:",encoder_out.shape,"encoder_mask:",encoder_mask)
        #返回encoder的结果和输入encoder的长度mask，每个batch内部的长度都不一样。
